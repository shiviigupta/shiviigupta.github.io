...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/pdf/ShiviGupta_Resume.pdf";
          },
      ...
      handler: () => {
    ...
    },{id: "news-mortar-board-b-tech-from-iit-kanpur-with-a-double-major-in-electrical-engineering-and-physics-minors-in-computer-science-and-english-literature",
          title: ':mortar_board: B.Tech. from IIT Kanpur with a double major in Electrical Engineering and...',
          description: "",
          ...
          description: "",
          section: "News",},{id: "projects-evaluating-persuasiveness-of-large-language-models",
